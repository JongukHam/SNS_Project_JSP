...
//	인자로 Application 레이어에 해당하는 객체만 주어지만 알아서 객체 속성이 설정되어 만들어지므로 편하다
	...
	public String saveFiles(Part filePart, String ImageFolderPath, String memberId) {
		...
		String realPath = this.uploadPath + File.separator + ImageFolderPath; //저장될 실제 폴더 경로(~ImageFile폴더 + 년월일폴더)
		...
		return File.separator + ImageFolderPath + File.separator + saveFileName ; //년월일 + 파일이름
	}
...
//	public String createFileName(String memberId) {
//		LocalDateTime date = LocalDateTime.now();
